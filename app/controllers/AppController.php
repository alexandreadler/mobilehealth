...
class AppController extends Controller {
    ...
    /**
     * 
     * Obtem informações iniciais:
     
     *  * Conteúdos recomendados;
     
     *  * Mensagens;
     
     *  * Nome, foto do usuário logado;
     
     *  * Post de noticias;
     
     *  Diferencia se é um supervisor ou um usuário normal 
    */
    public function getHome() {

        // Armazena as novas mensagens
        ...
        // Um array com o nome e o sobrenome do usuário
        ...
        // Armazena as infornações do usuário em session para serem usuadas ao logno do uso da aplicação
