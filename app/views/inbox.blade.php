                ...
                <div class="ui-body ui-body-a">
                    @for($c =0; $c <= $i;$c++)
                        ...
                            <h4>{{$m[$c][0]}}</h4>
							...
							<a href="#popupDefazamizade{{$c}}" data-rel="popup" data-position-to="window" data-transition="pop" class="ui-btn ui-btn-inline ui-icon-mail ui-btn-icon-top">Apagar Conversa</a>
